...
class ChangeDetection:
    ...
    # HOST= 'http://inseop.pythonanywhere.com'
    username= input("Enter your username: ") # 사용자 이름 입력
    password= input("Enter your password: ") # 비밀번호 입력

    # 이름과 비밀번호를 평문으로 코드에 포함하면 보안상의 위험이 있어서 사용자에게 직접 입력받도록 수정했습니다.
    ...
    def send(self, save_dir, image):
        ...
        cv2.imwrite(full_path, dst) # 인증이 필요한 요청에 아래의 headers를 붙임
